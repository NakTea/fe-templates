...
const IconWarningWeixian = ({ size = 16, width, height, color, ...rest }: IIconItemProps) => (
  <Svg
    ...
    {...rest}
  >
    <G clipPath="url(#clip0_3813_385)">
      <Path
        fill={getIconColor(color, 0, '#BE1B1B')}
...
export default IconWarningWeixian;
