...
const remoteSource = {
  uri: 'https://hojo-website-daily.oss-cn-shanghai.aliyuncs.com/hojo-static/demo/lottie/demo/navidad/data.json',
};

const remoteSource2 = {
  uri: 'https://hojo-website-daily.oss-cn-shanghai.aliyuncs.com/hojo-static/demo/lottie/demo/happy2016/data.json',
};
...
//       <LottieView source={{ uri: 'https://raw.githubusercontent.com/lottie-react-native/lottie-react-native/master/apps/paper/src/animations/Watermelon.json' }} autoPlay loop />
//     </View>
//   );
// }

const App = () => {
  const [source, setSource] = React.useState(remoteSource2);
