...
const WeatherRain = ({ size = 16, width, height, color, ...rest }: IIconItemProps) => (
  <Svg
    ...
    <G clipPath="url(#clip0_1687_3447)">
      <Ellipse cx={13.907} cy={13.732} fill={getIconColor(color, 0, 'url(#paint0_linear_1687_3447)')} rx={10.925} ry={10.759} />
