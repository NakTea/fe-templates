...
const SystemFavoriteLine = ({ size = 16, width, height, color, ...rest }: IIconItemProps) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={width || size} height={height || size} {...rest}>
    <Path
      id="Layer_54"
...
export default SystemFavoriteLine;
