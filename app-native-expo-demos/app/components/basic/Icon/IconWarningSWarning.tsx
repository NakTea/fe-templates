...
const IconWarningSWarning = ({ size = 16, width, height, color, ...rest }: IIconItemProps) => (
  <Svg
    ...
    height={height || size}
    {...rest}>
    <G clipPath="url(#clip0_3813_401)">
      <Path
        fill={getIconColor(color, 0, '#EF952F')}
...
export default IconWarningSWarning;
